...
export default function Convo() {
  ...
  const [messages, setMessages] = useState<AssistantMessage[]>([
    {
      id: 1,
      role: "assistant",
      text: "Hello! I am Convo, your intelligent assistive communication partner. I can translate speech to sign language, read text aloud, or help you practice gestures. How can I support your conversation today?",
  ...
  function generateAssistantReply(userMsg: string): { reply: string; signable: string } {
    ...
    if (lower.includes("hello") || lower.includes("hi") || lower.includes("hey")) {
      return {
        reply: "Hello! Welcome to Convo. You can speak to me using your microphone, type any sentence, or sign on camera!",
        signable: "hello",
      };
    }
        ...
        <main className="lg:col-span-7 flex flex-col justify-between space-y-4">
          ...
          <div className="flex items-center gap-2 pt-3 border-t border-slate-800/80">
            ...
            <input
              ...
              placeholder="Ask Convo, speak, or sign..."
